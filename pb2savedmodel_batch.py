...
parser.add_argument("--pb_dir", default="weights/tmp_opti.pb", help="Directory where to read training checkpoints.", type=str)
...
parser.add_argument("--class_num", default=21, help="class num", type=int)
